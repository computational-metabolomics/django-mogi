...
class ISAFileFilter(filters.FilterSet):
    investigation = django_filters.CharFilter('run__assaydetail__assay__study__investigation__name',
                                  lookup_expr='contains', label="Investigation contains")

    study = django_filters.CharFilter('run__assaydetail__assay__study__name',
                                              lookup_expr='contains', label="Study contains")

    assay = django_filters.CharFilter('run__assaydetail__assay__name',
                                              lookup_expr='contains', label="Assay contains")

    sample_name = django_filters.CharFilter('run__assaydetail__studysample__sample_name',
                                      lookup_expr='contains', label="Sample name contains")

    technical_replicate = django_filters.CharFilter('run__technical_replicate',
                                            lookup_expr='contains', label="technical_replicate contains")

    spe_type = django_filters.CharFilter('run__assaydetail__speprocess__speprotocol__spetype__type',
                                                    lookup_expr='contains', label="SPE type contains")

    spe_frac = django_filters.CharFilter('run__assaydetail__speprocess__spefrac',
                                         lookup_expr='contains', label="SPE frac contains")

    chromatography = django_filters.CharFilter(
        'run__assaydetail__chromatographyprocess__chromatographyprotocol__chromatographytype__type',
        lookup_expr='contains', label="Chromatography contains")

    chromatographyfrac = django_filters.CharFilter(
        'run__assaydetail__chromatographyprocess__chromatographyfrac',
        lookup_expr='contains', label="Chromatography frac contains")

    measurement = django_filters.CharFilter(
        'run__assaydetail__measurementprocess__measurementprotocol__measurementtechnique__type',
        lookup_expr='contains', label="Measurement contains")

    polarity = django_filters.CharFilter(
        'run__assaydetail__measurementprocess__polaritytype__type',
