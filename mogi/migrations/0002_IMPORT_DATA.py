...
def forwards_func(apps, schema_editor):
    ...
    lc_protocol = ChromatographyProtocol(name="DMA D. magna Syncronis phenyl",
                                         description="Syncronis Phenyl, 100 x 2.1 mm (length x internal diameter), 1.7 µm particle size",
                                         instrument_name='Thermo Scientific Ultimate 3000',
                                         version=1,
                                         code_field="D-PHE",
    ...
    lc_protocol = ChromatographyProtocol(name="DMA D. magna Accucore C30",
                                         description="Accucore C30, 100 x 2.1 mm (length x internal diameter), 2.6 µm particle size, 150 Angstrom pore size",
                                         instrument_name='Thermo Scientific Ultimate 3000',
                                         version=1,
                                         code_field="D-C30",
                                         chromatographytype=ChromatographyType.objects.filter(
    ...
    lc_protocol = ChromatographyProtocol(name="DMA D. magna Accucore Amide",
                                         description="Accucore 150 Amide, 100 x 2.1 mm (length x internal diameter), 2.6 µm particle size",
                                         instrument_name='Thermo Scientific Ultimate 3000',
                                         version=1,
                                         code_field="D-AMD",
                                         chromatographytype=ChromatographyType.objects.filter(
