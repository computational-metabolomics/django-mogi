...
urlpatterns = [
    ...
    ##############################################
    url(r'^history_mogi/$', views_galaxy.HistoryMogiListView.as_view(), name='history_mogi'),
    url(r'^history_mogi_data/(?P<pk>\d+)/$', views_galaxy.HistoryDataMogiListView.as_view(), name='history_mogi_data'),
    url(r'^history_mogi_data_save/(?P<history_internal_id>\d+)/(?P<galaxy_id>\w+)/$',
        views_galaxy.HistoryDataMogiCreateView.as_view(), name='history_mogi_data_save'),
    ...
    url(r'^history_mogi_data_from_rest_save/(?P<galaxy_name>\w+)/(?P<galaxy_data_id>\w+)/(?P<galaxy_history_id>\w+)/$',
        views_galaxy.HistoryDataMogiFromRestCreateView.as_view(), name='history_mogi_data_from_rest_save'),
    url(
