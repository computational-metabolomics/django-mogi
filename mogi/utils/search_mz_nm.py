...
def search_nm_chrom(target_mass, ppm_target_tolerance, ppm_library_tolerance, polarities, writer=None, first=False):
    ...
    with connection.cursor() as cursor:
        query = ''' 
                ...
                mbrowse_cannotation.sm_score AS sm_score, 
                mbrowse_cannotation.metfrag_score AS metfrag_score, 
                mbrowse_cannotation.mzcloud_score AS mzcloud_score,
                mbrowse_cannotation.sirius_csifingerid_score AS sirius_csifingerid_score,
                mbrowse_cannotation.probmetab_score AS probmetab_score,
                ...
                nm-((nm*0.000001)*{ppm}}) as nm_low, 
                nm+((nm*0.000001)*{ppm}) as nm_high, 
